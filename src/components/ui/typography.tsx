...
const H2 = forwardRef<HTMLHeadingElement, TypographyProps>(
    ({ className, children, ...props }, ref) => (
        <h2
            ref={ref}
            className={cn("scroll-m-20 text-xl font-medium tracking-tight first:mt-0", className)}
            {...props}
        >
            {children}
        </h2>
...
const H4 = forwardRef<HTMLHeadingElement, TypographyProps>(
    ({ className, children, ...props }, ref) => (
        <h4
            ref={ref}
            className={cn("scroll-m-20 text-base font-medium tracking-tight", className)}
            {...props}
        >
            {children}
        </h4>
...
const H6 = forwardRef<HTMLHeadingElement, TypographyProps>(
    ({ className, children, ...props }, ref) => (
        <h6
            ref={ref}
            className={cn("scroll-m-20 text-xs font-medium tracking-tight", className)}
            {...props}
        >
            {children}
        </h6>
